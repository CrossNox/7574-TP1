...
## [1.0.5] - 2022-05-07
### Fixed
- Exceptions handling in queries and metrics handlers

## [1.0.5] - 2022-05-07
### Fixed
- Move repeated code into functions on server
- Better handling of queue.Full exceptions on server

## [1.0.4] - 2022-05-07
### Fixed
- Abstract response protocol messages into class

## [1.0.3] - 2022-04-28
### Changed
- Use doubles for timestamps

### Fixed
- Bug where due to rounding errors some metrics were not considered for notifications

## [1.0.2] - 2022-04-28
### Fixed
- Fixed query reply when metric does not exist vs no data is available for range
